...
export const DEFAULT_HOME: HomeContent = {
  hero: {
    ...
    metaCenter: "Εξωραϊστικός Σύλλογος Άγιος Νεκτάριος",
    metaRight: "700μ. υψόμετρο",
    titleTop: "ΑΓΙΟΣ ",
    titleBottom: "ΝΕΚΤΑΡΙΟΣ",
    intro: "Στον υψηλότερο οικισμό του Κιθαιρώνα, εκεί που ανατράφηκε ο Ηρακλής.",
    ticker: TICKER,
  },
  stats: [
    {
  ...
  essence: {
    ...
    attribution: "Στροφή από το ποίημα του Γρηγόριου Δημοπούλου «Άγιος Νεκτάριος»",
  },
  settlement: {
    label: "Ο τόπος",
    title: "Ο οικισμός μας",
    paragraphs: [
      "Απλώνεται στις νότιες πλαγιές του Κιθαιρώνα, απέναντι από το όρος Πατέρα, στη θέση «Μαγκούλεζα» της κτηματικής περιφέρειας των Βιλίων, σε υψόμετρο 650 έως 700 μέτρων και περίπου 55 χιλιόμετρα από την Αθήνα.",
      "Ιδρύθηκε το 1970, όταν ο οικοδομικός συνεταιρισμός δημοσίων υπαλλήλων, στρατιωτικών και πολιτικών συνταξιούχων αγόρασε εδώ 373 στρέμματα. Σήμερα μετρά πάνω από 150 σπίτια και μερικές δεκάδες μόνιμους κατοίκους που κρατούν τον τόπο ζωντανό και τον χειμώνα. \n\nΑσφαλτοστρωμένους δρόμους, Πνευματικό Κέντρο, γήπεδο και ναό δεν τα χάρισε κανείς: τα έφτιαξαν οι ίδιοι οι οικιστές, με συνδρομές και εθελοντική δουλειά.",
    ],
    moreLabel: "Η συνέχεια της ιστορίας",
    moreHref: "/readmore-index-center",
    mapEmbedUrl: "https://maps.google.gr/maps?hl=el&ie=UTF8&t=h&ll=38.162535,23.291316&spn=0.01181,0.018239&z=15&output=embed",
    mapLinkUrl: "https://maps.google.gr/maps?hl=el&ie=UTF8&t=h&ll=38.162535,23.291316&spn=0.01181,0.018239&z=15&source=embed",
  },
  folklore: {
  ...
  event: {
    ...
    text: "Την άνοιξη οι πλαγιές γεμίζουν ορχιδέες και ο αέρας μυρίζει ρητίνη. Από την 1η Μαΐου αρχίζει η αντιπυρική περίοδος και τα οικόπεδα πρέπει να είναι καθαρά ως τις 15 Ιουνίου. Τον Ιούλιο και τον Αύγουστο ο οικισμός γεμίζει. Στα τέλη Αυγούστου συνέρχεται η Γενική Συνέλευση. Και μετά τις πρώτες βροχές το βουνό ησυχάζει, ώσπου να χιονίσει.",
  ...
  board: {
    ...
    members: [
      ...
      {
        role: "Αντιπρόεδρος",
        name: "Παπαμελετίου Αλεξάνδρα",
      },
      {
        role: "Γενικός Γραμματέας",
        name: "Περδίκης Χαράλαμπος",
      },
      {
        role: "Ταμίας",
        name: "Μπακάλη Βασιλική",
      },
      {
        role: "Έφορος",
        name: "Μαριάνθη - Μαρία Γλαντζή",
      },
      {
        role: "Αναπληρωτής Ταμία",
        name: "Πονηρός Ευάγγελος",
      },
      {
        role: "Ειδικός Γραμματέας",
        name: "Δημόπουλος Γρηγόριος",
      },
    ],
  },
  documents: {
    ...
    text: "Κάθε συνεδρίαση του Διοικητικού Συμβουλίου καταγράφεται και δημοσιεύεται.",
    links: [
      {
        title: "Το αρχείο των πρακτικών",
        href: "/Documents",
      },
      {
  ...
  news: {
    ...
    items: [
      {
        title: "Πυροπροστασία & καλοκαίρι - Χιόνι και χειμώνας",
        href: "/Pyroprostasia",
      },
      {
        title: "Πνευματικό & Πολιτιστικό Κέντρο",
        href: "/PPKnews",
      },
      {
        title: "Η εφημερίδα «Κιθαιρώνας»",
        href: "/Newspaper",
      },
      {
  ...
  contact: {
    ...
    text: "Αυτή η ιστοσελίδα γράφεται από οικιστές, όχι από επαγγελματίες. Αν έχετε κάτι να πείτε, μια μαρτυρία, μια φωτογραφία, μια ένσταση στείλτε μας.",
    email: "agiosnektarios.vilia@gmail.com",
  },
};
