  ...
  return (
    <form action={formAction} className="space-y-8">
      ...
      <Panel
        ...
        description="Προαιρετικό: ανεβάστε πραγματικές φωτογραφίες του τόπου στα «Αρχεία» και επικολλήστε εδώ τους συνδέσμους. Το σκηνικό τις φωτίζει ανάλογα με την ώρα και τον καιρό."
      >
        <div className="grid gap-5 md:grid-cols-2">
          {(
            [
